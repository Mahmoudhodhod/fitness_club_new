...
class _GenderPickerWithImageState extends State<GenderPickerWithImage> {
  ...
  Widget build(BuildContext context) {
    return getHorizontalAlignedView();
  }
                    ...
                    Stack(
                      ...
                      children: <Widget>[
                        Container(
                          height: widget.size,
                          width: widget.size,
                          margin: const EdgeInsets.only(top: 0, bottom: 0, right: 5.0),
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          decoration: BoxDecoration(
                              shape: widget.isCircular ? BoxShape.circle : BoxShape.rectangle,
                              image: DecorationImage(
                                  image: widget.femaleImage, alignment: Alignment.center, fit: BoxFit.cover)),
                          child: AnimatedOpacity(
