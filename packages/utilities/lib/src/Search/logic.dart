...
// *** Copied from flutter internal files. ***

const Duration _kDebounceDuration = Duration(milliseconds: 800);
...
abstract class SearchDelegate<T> {
  ...
  SearchDelegate({
    ...
    _queryTextController = TextEditingController()
      ..addListener(() => _streamController.sink.add(query));
    _streamSubscription = _streamController.stream
        .skip(1)
        .debounceTime(_kDebounceDuration)
        .listen((q) => queryChanged(q));
